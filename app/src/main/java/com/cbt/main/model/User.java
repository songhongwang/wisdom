...
public class User {
    ...
    public void setArcount(String arcount) {
    ...
    public void setIrcount(String ircount) {
    ...
    public void setMrcount(String mrcount) {
    ...
    public String getYinwenming() {
        return yinwenming;
    }

    public void setYinwenming(String yinwenming) {
        this.yinwenming = yinwenming;
    }
}
