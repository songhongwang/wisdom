...
public class MoreProductAdapter extends AppBaseAdapter {
    public MoreProductAdapter(List<IndexProductModel> dataList, Context context) {
        super(dataList, context);
    }

    @Override
    public View getCView(final int position, View view, ViewGroup viewGroup) {
        View itemView = mInflater.inflate(R.layout.item_more_product, null, false);
