...
public class ReleaseShichangActivity extends BaseActivity{
    ...
    @BindView(R.id.tv_str_gongqiu)
    TextView mTvStrGongqiu;
    ...
    @BindView(R.id.rl_gongqiuleixing)
    RelativeLayout mRlGongqiuLeixing;
    ...
    List<TypeModel> mOptionGongqiuList = new ArrayList<>();
    ...
    public void onCCreate(@Nullable Bundle savedInstanceState) {
        setContentView(R.layout.activity_release_shichang);
    }
    ...
    public void initUI() {
        ...
        mGridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                if(s.equals("holder")){
                    Intent intent = new Intent(ReleaseShichangActivity.this, MultiImageSelectorActivity.class);
                    // whether show camera
                    ...
                    // 查看图片
                    Intent showIntent =new Intent(ReleaseShichangActivity.this, ShowActivity.class);
        ...
        mRlLocation.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                //条件选择器
                OptionsPickerView pvOptions = new  OptionsPickerView.Builder(ReleaseShichangActivity.this, new OptionsPickerView.OnOptionsSelectListener() {
                    @Override
        ...
        mRlGongqiuLeixing.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                onxingDialog();
            }
 ...
 public void initselectData() {
     ...
     ApiClient.getInstance().getBasicService(this).findType(null, 9).enqueue(new Callback<List<Dictionaries>>() {
         @Override
         public void onResponse(Call<List<Dictionaries>> call, Response<List<Dictionaries>> response) {
             List<Dictionaries> dataList = response.body();
             for (int i = 0; i < dataList.size(); i++) {
     ...
     ApiClient.getInstance().getBasicService(this).findType(null, 8).enqueue(new Callback<List<Dictionaries>>() {
         @Override
         public void onResponse(Call<List<Dictionaries>> call, Response<List<Dictionaries>> response) {
             List<Dictionaries> dataList = response.body();
             for (int i = 0; i < dataList.size(); i++) {
                 mOptionGongqiuList.add(new TypeModel(dataList.get(i).getId(), dataList.get(i).getName()));
             }
...
//                                + options2Items.get(options1).get(option2)
//                                + options3Items.get(options1).get(option2).get(options3);
                gongqiuid = mOptionGongqiuList.get(options1).getId();
                mTvStrGongqiu.setText(mOptionGongqiuList.get(options1).getName());
            }
        }).build();


        pvOptions.setPicker(mOptionGongqiuList);
        pvOptions.show();
    }
    ...
    private void commit() {
        ...
        ApiClient.getInstance().getBasicService(this).uploadFarmGongqState(
                province,
                city,
                country,
                onetype,
