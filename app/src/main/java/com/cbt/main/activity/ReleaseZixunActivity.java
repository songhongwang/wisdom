...
public class ReleaseZixunActivity extends BaseActivity{
    ...
    public void onCCreate(@Nullable Bundle savedInstanceState) {
        setContentView(R.layout.activity_release_zixun);
    }
    ...
    public void initUI() {
        ...
        mGridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                if(s.equals("holder")){
                    Intent intent = new Intent(ReleaseZixunActivity.this, MultiImageSelectorActivity.class);
                    // whether show camera
                    ...
                    // 查看图片
                    Intent showIntent =new Intent(ReleaseZixunActivity.this, ShowActivity.class);
        ...
        mRlLocation.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                //条件选择器
                OptionsPickerView pvOptions = new  OptionsPickerView.Builder(ReleaseZixunActivity.this, new OptionsPickerView.OnOptionsSelectListener() {
                    @Override
 ...
 public void initselectData() {
     ...
     ApiClient.getInstance().getBasicService(this).findType(null, 6).enqueue(new Callback<List<Dictionaries>>() {
         @Override
         public void onResponse(Call<List<Dictionaries>> call, Response<List<Dictionaries>> response) {
             List<Dictionaries> dataList = response.body();
             for (int i = 0; i < dataList.size(); i++) {
...
//                                + options3Items.get(options1).get(option2).get(options3);
    ...
    private void commit() {
        ...
        ApiClient.getInstance().getBasicService(this).uploadFarmZixunState(
                province,
                city,
                country,
                onetype,
            ...
            public void onResponse(Call<Object> call, Response<Object> response) {
                ...
                ToastUtils.show(ReleaseZixunActivity.this, "发布成功");
                finish();
            }

            @Override
            public void onFailure(Call<Object> call, Throwable t) {
                ToastUtils.show(ReleaseZixunActivity.this, "发布失败");
            }
        });
