...
public class ReleaseNongActivity extends BaseActivity{
    ...
    public void onCCreate(@Nullable Bundle savedInstanceState) {
        setContentView(R.layout.activity_release_nong);
    }
    ...
    public void initUI() {
        ...
        mGridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                if(s.equals("holder")){
                    Intent intent = new Intent(ReleaseNongActivity.this, MultiImageSelectorActivity.class);
                    // whether show camera
                    ...
                    // 查看图片
                    Intent showIntent =new Intent(ReleaseNongActivity.this, ShowActivity.class);
        ...
        mRlLocation.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                //条件选择器
                OptionsPickerView pvOptions = new  OptionsPickerView.Builder(ReleaseNongActivity.this, new OptionsPickerView.OnOptionsSelectListener() {
                    @Override
...
//                                + options3Items.get(options1).get(option2).get(options3);
    ...
    private void commit() {
        ...
        ApiClient.getInstance().getBasicService(this).uploadFarmNongState(
                province,
                city,
                country,
                onetype,
            ...
            public void onFailure(Call<Object> call, Throwable t) {
                ToastUtils.show(ReleaseNongActivity.this, "发布失败");
            }
        });
